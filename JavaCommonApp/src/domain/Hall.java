 ...
 * @author Dell E5450
 */
public class Hall extends DomainObject implements Serializable {
    ...
    public List<DomainObject> getParamsForSelect1(ResultSet rs) throws Exception {
        ...
        while (rs.next()) {
            Hall hall = new Hall(rs.getInt("hallID"), rs.getString("adress"), rs.getInt("floor"));

            halls.add(hall);
        }

        return (List<DomainObject>) halls;
    }
